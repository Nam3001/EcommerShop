...
$brand = $brandDao->selectById($brandId);
if(count($brand) === 0) {
        ...
        <main>
            <div class="container-fluid p-4">
                <form id="formUpdate" method="post"
                      action="handle/handleUpdateBrand.php">
                    <div class="">
                        <h4 class="">Cập nhật thương hiệu</h4>
                    </div>
                    <div>
                        ...
                        <input type="text" style="display: none;" value="<?php echo $brandId ?>" name="brandId"/>
                        <div class="form-group mt-3">
                            ...
                            <textarea class="form-control" id="description" name="description" style="height: 100px;"
                                      ><?php echo $brand['description']; ?></textarea>
                        </div>
                    </div>
...
<script>
    ...
    if (!updateSuccess) {
        ...
        toastElement.querySelector('.toast-body').textContent = 'Cập nhật thương hiệu thất bại!'
