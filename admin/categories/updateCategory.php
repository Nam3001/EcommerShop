        ...
        <main>
            <div class="container-fluid p-4">
                <form id="formUpdate" method="post"
                      action="handle/handleUpdateCategory.php">
                    <div class="">
                        <h4 class="">Cập nhật danh mục</h4>
                    </div>
                    <div>
                        ...
                        <input type="text" style="display: none;" value="<?php echo $categoryId ?>" name="categoryId"/>
                        <div class="form-group mt-3">
...
<script>
    ...
    if (!updateSuccess) {
        ...
        toastElement.querySelector('.toast-body').textContent = 'Cập nhật danh mục thất bại!'
