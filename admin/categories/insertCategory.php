        ...
        <main>
            <div class="container-fluid p-4">
                <form method="post" enctype="multipart/form-data" id="formInsert"
                      action="handle/handleInsertCategory.php">
                    <div class="modal-header">
                        <h4 class="modal-title">Thêm mới danh mục</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group mt-2">
                            <label for="name-insert">Tên danh mục phẩm:</label>
                            <input type="text" class="form-control" id="name" name="name" required>
                        </div>
                        <div class="form-group mt-2">
                            <label for="desc-insert">Mô tả danh mục:</label>
                            <textarea class="form-control" id="description" style="height: 100px" name="description"></textarea>
                        </div>
                    </div>
                    <div class="my-3 float-end">
                        <input type="submit" name="submit" class="btn btn-success" value="Thêm danh mục">
                    </div>
                </form>
            </div>
        </main>
...
<script>
    ...
    if (!insertSuccess) {
        ...
        toastElement.querySelector('.toast-body').textContent = 'Thêm danh mục thất bại!'
